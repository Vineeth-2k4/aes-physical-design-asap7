...
add_rings \ -nets {VDD VSS} \ -type core_rings \ -follow core \ -layer {top M9 bottom M9 left M9 right M9} \ -width {top 3.2 bottom 3.2 left 3.2 right 3.2} \ -spacing {top 2 bottom 2 left 2 right 2} \ -offset {top 1 bottom 1 left 1 right 1} 
set_db add_rings_target default 
set_db add_rings_extend_over_row 0 
set_db add_rings_ignore_rows 0 
set_db add_rings_avoid_short 0 
...
set_db add_rings_orthogonal_only true 
set_db add_rings_skip_via_on_pin {standardcell} 
add_rings \ -nets {VDD VSS} \ -type core_rings \ -follow core \ -layer {top M8 bottom M8 left M8 right M8} \ -width {top 3.2 bottom 3.2 left 3.2 right 3.2} \ -spacing {top 2 bottom 2 left 2 right 2} \ -offset {top 1 bottom 1 left 1 right 1} 
...
add_stripes \ -nets {VDD VSS} \ -layer M6 \ -direction horizontal \ -width 0.64 \ -spacing 0.8 \ -set_to_set_distance 25 \ -start_from left \ -start_offset 2 \ -stop_offset 2 \ -max_same_layer_jog_length 2 \ -merge_stripes_value 0.1 \ -pad_core_ring_top_layer_limit Pad \ -pad_core_ring_bottom_layer_limit M1 \ -snap_wire_center_to_grid grid 
add_stripes \ -nets {VDD VSS} -layer M7 \ -direction vertical \ -width 0.64 \ -spacing 0.8 \ -set_to_set_distance 25 \ -start_from bottom -start_offset 2 \ -stop_offset 2 \ -max_same_layer_jog_length 2 \ -merge_stripes_value 0.1 \ -pad_core_ring_top_layer_limit Pad \ -pad_core_ring_bottom_layer_limit M1 \ -snap_wire_center_to_grid grid 
...
route_special \^M -connect {core_pin floating_stripe } \^M -nets {VDD VSS} \^M -allow_jogging 1 \^M -crossover_via_layer_range {M6 Pad} \^M -target_via_layer_range {M6 Pad} \^M -layer_change_range {M6 Pad} \^M -block_pin_target nearest_target \^M -pad_pin_target nearest_target ^M -nearest_target 1
